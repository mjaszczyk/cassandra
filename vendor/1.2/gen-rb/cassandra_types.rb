...
# no actual schema agreement validation is done starting from CassandraLegacy 1.2
# 
...
# @param deletion. A deletion of a column or supercolumn
  ...
  # A TokenRange describes part of the CassandraLegacy ring, it is a mapping from a range to
