=begin rdoc
Create a new CassandraLegacy client instance. Accepts a keyspace name, and optional host and port.

  client = CassandraLegacy.new('twitter', '127.0.0.1:9160')
...
<tt>:consistency</tt>:: The consistency level of the request. Defaults to <tt>CassandraLegacy::Consistency::ONE</tt> (one node must respond). Other valid options are <tt>CassandraLegacy::Consistency::ZERO</tt>, <tt>CassandraLegacy::Consistency::QUORUM</tt>, and <tt>CassandraLegacy::Consistency::ALL</tt>.
...
class CassandraLegacy
  ...
  # Create a new CassandraLegacy instance and open the connection.
  def initialize(keyspace, servers = "127.0.0.1:9160", thrift_client_options = {})
    ...
    thrift_client_options[:transport_wrapper] ||= CassandraLegacy.DEFAULT_TRANSPORT_WRAPPER
  ...
  ##
  # Return a CassandraLegacy::Keyspace object loaded with the current
  # keyspaces schema.
  #
  # Please note that this only works on version 0.7.0 and higher.
  ...
  #
  # This method calls CassandraLegacy#truncate! for each column family in the
  # keyspace.
  #
  # Please note that this only works on version 0.7.0 and higher.
  #
  ...
  # CassandraLegacy::ColumnFamily instance, and returns the schema id.
  #
  ...
  ##
  # Multi-key version of CassandraLegacy#count_columns. Please note that this
  # queries the server for each key passed in.
  #
  # Supports same parameters as CassandraLegacy#count_columns.
  #
  # * column_family - The column_family that you are inserting into.
  ...
  ##
  # Multi-key version of CassandraLegacy#get_columns. Please note that this
  # queries the server for each key passed in.
  #
  # Supports same parameters as CassandraLegacy#get_columns
  #
  # * column_family - The column_family that you are inserting into.
  # * keys - An array of keys to select.
  # * columns - Either a single super_column or a list of columns.
  ...
  ##
  # Return a hash (actually, a CassandraLegacy::OrderedHash) or a single value
  ...
  ##
  # Multi-key version of CassandraLegacy#get.
  #
  ...
  # returned.
  #
  # Supports the same parameters as CassandraLegacy#get.
  #
  # * column_family   - The column_family that you are inserting into.
  # * keys            - An array of keys to select.
  ...
  ##
  # Return an CassandraLegacy::OrderedHash containing the columns specified for the given
  # range of keys in the column_family you request.
  #
  # This method is just a convenience wrapper around CassandraLegacy#get_range_single
  # and CassandraLegacy#get_range_batch. If :key_size, :batch_size, or a block
  # is passed in CassandraLegacy#get_range_batch will be called. Otherwise
  # CassandraLegacy#get_range_single will be used.
  #
  # The start_key and finish_key parameters are only useful for iterating of all records
  # as is done in the CassandraLegacy#each and CassandraLegacy#each_key methods if you are using the
  # RandomPartitioner.
  #
  ...
  #
  # Please note that CassandraLegacy returns a row for each row that has existed in the
  ...
  # range of keys in the column_family you request.
  #
  # See CassandraLegacy#get_range for more details.
  #
  ...
  #
  # If a block is passed in we will yield the row key and columns for
  # each record returned and return a nil value instead of a CassandraLegacy::OrderedHash.
  #
  # See CassandraLegacy#get_range for more details.
  #
  ...
  #
  # This method just calls CassandraLegacy#get_range_keys and returns the
  # number of records returned.
  #
  # See CassandraLegacy#get_range for options.
  #
  ...
  #
  # This method just calls CassandraLegacy#get_range and returns the
  ...
  #
  # This method just calls CassandraLegacy#get_range and yields each row key.
  #
  # See CassandraLegacy#get_range for options.
  #
  ...
  #
  # This method just calls CassandraLegacy#get_range and yields the key and
  # columns.
  #
  # See CassandraLegacy#get_range for options.
  #
  ...
  #
  def batch(options = {})
    @batch = CassandraLegacy::Batch.new(self, options)
  ...
  # CassandraLegacy#get_index_slices
  #
